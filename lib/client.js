	...
	factory: (require) => {
		...
		const THEMES = {
			...
			dusk: {
				label: "岁相 · 水墨",
				accent: "#5b6fd8",
				accentSoft: "rgba(91, 111, 216, 0.15)",
				accentLine: "rgba(91, 111, 216, 0.55)",
				surface: "linear-gradient(158deg, rgba(20,22,42,.97), rgba(9,10,20,.99))",
				hairline: "rgba(150, 160, 230, 0.15)",
				text: "#e8e9f8",
			...
			React.useEffect(() => {
				...
				image.onload = () => {
					...
					blink = createBlink(host.current, {
						...
						// Only the chibi looks blink — declared per look, not guessed from the id.
						eyes: frame.blink === true ? (frame.eyes ?? null) : null,
